...
namespace ToDoTests.Fixture_version2.Tests.Chrome
{
    public class CompileToJSTodoTests : IClassFixture<ChromeDriverFixture>
    {
        private const string URL = "https://todomvc.com/";
        private readonly ChromeDriverFixture _fixture;

        public CompileToJSTodoTests(ChromeDriverFixture fixture)
        {
            _fixture = fixture;
        }
